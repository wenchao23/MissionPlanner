namespace MissionPlanner.Swarm
{
    partial class FormationControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.BUT_follow_me.Text = "F.M.(off)";
            ...
            this.tabControl1.Location = new System.Drawing.Point(12, 89);//default 12,39
            ...
            this.Controls.Add(this.BUT_demospoof);//add BUT_altadd
            this.Controls.Add(this.BUT_follow_me);//add BUT_altadd
            ...
            this.Controls.Add(this.BUT_flyto_distangle);//add BUT_altadd
